export default function Confirm({ auth, cart }: any) {
  return (
    <section className="py-24 relative">
      <div className="w-full max-w-7xl px-4 md:px-5 lg:px-5 mx-auto">
        <div className="w-full flex-col justify-start items-center lg:gap-12 gap-8 inline-flex">
          <div className="flex-col justify-start items-center gap-3 flex">
            <h2 className="text-center text-grey-900 text-3xl font-bold font-manrope leading-normal">
              John, Thank You for Your Order!
            </h2>
            <p className="max-w-xl text-center text-grey-500 text-lg font-normal leading-8">
          ...
          <div className="w-full flex-col justify-start items-center lg:gap-10 gap-8 flex">
            <div className="w-full flex-col justify-start items-start gap-6 flex">
              <div className="w-full flex-col justify-start items-start gap-5 flex">
                <div className="w-full md:px-6 px-2 py-4 border-y border-grey-200 justify-between items-center inline-flex">
                  <h3 className="text-grey-900 text-xl font-medium leading-8">
                    Item
                  </h3>
                  <h3 className="text-right text-grey-900 text-xl font-medium leading-8">
                    Total
                  </h3>
                </div>
                <div className="w-full md:px-6 px-2 pb-5 justify-between items-center gap-8 inline-flex border-b border-grey-300">
                  <div className="justify-start items-center gap-6 flex md:pb-5">
                    ...
                    <div className="flex-col justify-start items-start gap-1.5 inline-flex">
                      <h5 className="text-grey-900 text-lg font-semibold leading-relaxed">
                        Simple Black T-shirt
                      </h5>
                      <h6 className="text-grey-500 text-base font-normal leading-relaxed">
                        QTY: 1
                      </h6>
                    </div>
                  </div>
                  <h4 className="text-right text-grey-900 text-lg font-medium leading-relaxed">
                    $52.00
                  </h4>
                </div>
                <div className="w-full md:px-5 px-2 pb-6 justify-between items-center gap-8 inline-flex border-b border-grey-300">
                  <div className="justify-start items-center gap-6 flex md:pb-6">
                    ...
                    />
                    <div className="flex-col justify-start items-start gap-1.5 inline-flex">
                      <h4 className="text-grey-900 text-xl font-medium leading-8">
              ...
              <div className="w-full md:pt-6 justify-start items-center gap-5 flex md:flex-row flex-col">
                <div className="w-full md:px-6 px-2 flex-col justify-start items-start gap-5 inline-flex md:border-r md:border-b-0 border-b md:pb-0 pb-5 border-grey-200">
                  <div className="w-full justify-between items-center inline-flex gap-4">
                    <h5 className="text-grey-500 text-lg font-normal leading-relaxed">
                      Estimated Delivery:
                    </h5>
                    <h5 className="text-right text-grey-500 text-lg font-normal leading-relaxed">
                      Friday, 3rd Jun 2023
                    </h5>
                  </div>
                  <div className="w-full justify-between items-center inline-flex gap-4 border-y border-grey-200 py-5">
                    <h5 className="text-grey-500 text-lg font-normal leading-relaxed">
                      Delivery Address:
                    </h5>
                    <h5 className="text-right text-grey-500 text-lg font-normal leading-relaxed">
                ...
                <div className="w-full md:px-6 px-2 flex-col justify-start items-start gap-5 inline-flex">
                  <div className="w-full pb-6 border-b border-grey-200 flex-col justify-start items-start gap-6 flex">
                    <div className="w-full justify-between items-start gap-6 inline-flex">
                      <h5 className="text-grey-500 text-lg font-normal leading-relaxed">
                        Subtotal
                      </h5>
                      <h5 className="text-right text-grey-900 text-lg font-semibold leading-relaxed">
                        $172.00
                      </h5>
                    </div>
                    <div className="w-full justify-between items-start gap-6 inline-flex">
