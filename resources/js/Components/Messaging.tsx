...
export default function Messaging({
  ...
  // Run on component mount to trigger the close event after a timeout
  const [showMessage, setShowMessage] = React.useState(show);
  React.useEffect(() => {
    if (show) {
            ...
            <div className="success-alert cursor-default flex items-center justify-between w-fit rounded-lg bg-indigo-500 px-[10px] shadow-lg">
              <div className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-gray-100 text-base">{message}</p>
                </div>
              </div>
              <button
